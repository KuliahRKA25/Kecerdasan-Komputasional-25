...
try:
    ...
    # qpsolvers hanya dipakai SVM, tidak dipakai di modul Logical Agents.
    # Dibuat opsional supaya notebook.py (psource) tetap bisa diimpor.
    solve_qp = None

from environment.probabilistic_learning import NaiveBayesLearner
