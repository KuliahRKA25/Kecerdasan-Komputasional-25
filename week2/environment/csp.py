...
import environment.search as search
from environment.utils import argmin_random_tie, count, first, extend
...
def ac_search_solver(csp, arc_heuristic=sat_up):
    ...
    from environment.search import depth_first_tree_search
    solution = None
    try:
